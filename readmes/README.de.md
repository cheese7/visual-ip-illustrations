...
`{visual IP}` kann `Xiaohei`, `Littlebox`, `Tom`, `Ferris`, `Seal`, `OpenClaw`, `Go Gopher`, `Cai Xukun` oder ein unterstützter Alias sein. Eine ausgelassene visuelle IP wählt Xiaohei.
