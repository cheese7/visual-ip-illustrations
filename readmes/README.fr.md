...
L’identité publique de la Release 1.4 utilise `Visual IP Illustrations`, le slug canonique de checkout local `visual-ip-illustrations` et l’invocation canonique `$visual-ip-illustrations`. Les surfaces de compatibilité restent stables : répertoire installable `skills/visual-ip-illustrations/`, alias legacy `$ian-xiaohei-illustrations`, routes sources existantes `skills/visual-ip-illustrations/`, comportement des routes, répertoires de sortie et marqueurs du validateur.
...
Alias : `OpenClaw`, `openclaw`, `OpenClaw logo`, `OpenClaw mascot`, ainsi que les alias OpenClaw listés dans `skills/visual-ip-illustrations/references/routing.md`.
...
- Répertoire installable du package skill : `skills/visual-ip-illustrations/`
- Remote live actuel du dépôt : `https://github.com/yangchuansheng/visual-ip-illustrations.git`
