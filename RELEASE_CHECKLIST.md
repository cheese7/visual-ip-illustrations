...
Phase 52 owns Hermes Agent validator parity, Node tests, final release evidence, docs consistency, leakage scan, and public sample gate automation before Hermes Agent public release evidence.

Phase 57 owns Linux Mascot validator parity, Node tests, final release evidence, docs consistency, leakage scan, route smoke, public sample gate automation, generated sample gate automation, and release evidence before Linux Mascot public release evidence.

Phase 57 owns Linux Mascot route smoke automation and final manual smoke evidence before public generated Linux Mascot sample release.
...
- [ ] Confirm Hermes Agent remains an explicit `source-reviewed` uploaded-image article-illustration route with aliases `Hermes Agent`, `Hermes`, `hermes`, `hermes-agent`, `Hermes logo`, and `Hermes Agent logo`, source authority `skills/visual-ip-illustrations/references/ips/hermes/source.md`, uploaded-image authority from `Generated image 1 (16).jpeg`, raw output path `assets/<article-slug>-hermes/`, escaped output path `assets/&lt;article-slug&gt;-hermes/`, official source context, MIT license context, mythology-drift boundary, product-poster boundary, public sample review gate, route isolation, uploaded-character-only article illustration output, and release review terms for endorsement, affiliation, sponsorship, approval, and impersonation claims.
- [ ] Confirm Linux Mascot remains an explicit `source-reviewed` uploaded-image article-illustration route with aliases `Linux Mascot`, `Linux mascot`, `Linux`, `linux`, `Tux`, `tux`, `Linux penguin`, and `Tux penguin`, source authority `skills/visual-ip-illustrations/references/ips/linux/source.md`, uploaded-image authority from `/Users/longnv/Downloads/Linux-logo.jpg`, raw output path `assets/<article-slug>-linux/`, escaped output path `assets/&lt;article-slug&gt;-linux/`, Larry Ewing Tux attribution, The GIMP attribution condition, Linux Foundation trademark guidance, Linux mark ownership context, distro-logo boundary, product-output boundary, public sample review gate, route isolation, uploaded-image-only Tux article illustration output, and release review terms for endorsement, certification, compatibility, Linux Foundation logo use, product-poster output, CLI screenshots, web hero graphics, kernel dashboard screenshots, and operating-system marketing graphics.
...
- [ ] Explicit Hermes Agent smoke: request `Hermes Agent`, `Hermes`, `hermes`, `hermes-agent`, `Hermes logo`, or `Hermes Agent logo` and confirm route status `source-reviewed`, source authority `skills/visual-ip-illustrations/references/ips/hermes/source.md`, route-local directory `skills/visual-ip-illustrations/references/ips/hermes/`, output path `assets/<article-slug>-hermes/`, docs validation token `assets/&lt;article-slug&gt;-hermes/`, uploaded-image authority from `Generated image 1 (16).jpeg`, official source context, MIT license context, mythology-drift boundary, product-poster boundary, public sample review gate, route isolation, uploaded-character-only article illustration output, and neutral article-concept rewrites for official endorsement, affiliation, sponsorship, approval, and impersonation claims.
- [ ] Explicit Linux Mascot smoke: request `Linux Mascot`, `Linux mascot`, `Linux`, `linux`, `Tux`, `tux`, `Linux penguin`, or `Tux penguin` and confirm route status `source-reviewed`, source authority `skills/visual-ip-illustrations/references/ips/linux/source.md`, route-local directory `skills/visual-ip-illustrations/references/ips/linux/`, output path `assets/<article-slug>-linux/`, docs validation token `assets/&lt;article-slug&gt;-linux/`, uploaded-image authority from `/Users/longnv/Downloads/Linux-logo.jpg`, Larry Ewing Tux attribution, The GIMP attribution condition, Linux trademark-boundary note, public sample review gate, route isolation, distro-logo boundary, product-output boundary, and neutral article-concept rewrites for endorsement, certification, compatibility, Linux Foundation logo use, product-poster output, CLI screenshots, web hero graphics, kernel dashboard screenshots, and operating-system marketing graphics.
- [ ] Mixed-IP smoke: request the same core idea as Xiaohei, Littlebox, Tom, Ferris, Seal, OpenClaw, Go Gopher, Cai Xukun, Hermes Agent, and Linux Mascot variant groups and confirm each group loads its own references and output path.
...
- [ ] Review `NOTICE.md` for Hermes Agent source/MIT/uploaded-image/public sample gate: route id `hermes`, route status `source-reviewed`, aliases `Hermes Agent`, `Hermes`, `hermes`, `hermes-agent`, `Hermes logo`, and `Hermes Agent logo`, official website `https://hermes-agent.nousresearch.com/`, official repository `https://github.com/NousResearch/hermes-agent`, MIT license URL `https://github.com/NousResearch/hermes-agent/blob/main/LICENSE`, docs URL `https://hermes-agent.nousresearch.com/docs/`, source authority `skills/visual-ip-illustrations/references/ips/hermes/source.md`, uploaded-image authority from `Generated image 1 (16).jpeg`, output path `assets/<article-slug>-hermes/`, public generated Hermes samples gate, mythology-drift boundary, product-poster boundary, route isolation, uploaded-character-only article illustration output, and release review terms for official endorsement, affiliation, sponsorship, approval, and impersonation claims.
- [ ] Review `NOTICE.md` for Linux Mascot source attribution and public sample gate: route id `linux`, route status `source-reviewed`, aliases `Linux Mascot`, `Linux mascot`, `Linux`, `linux`, `Tux`, `tux`, `Linux penguin`, and `Tux penguin`, source authority `skills/visual-ip-illustrations/references/ips/linux/source.md`, uploaded-image authority from `/Users/longnv/Downloads/Linux-logo.jpg`, output path `assets/<article-slug>-linux/`, Larry Ewing Tux attribution, Linux 2.0 Penguins source, The GIMP attribution condition, Linux Foundation trademark guidance, Linux mark ownership context, public generated Linux Mascot samples gate, distro-logo boundary, product-output boundary, route isolation, and release review terms for endorsement, certification, compatibility, Linux Foundation logo use, product-poster output, CLI screenshots, web hero graphics, kernel dashboard screenshots, and operating-system marketing graphics.
...
- [ ] Scan Xiaohei, Littlebox, Tom, Ferris, Seal, OpenClaw, and Go Gopher route-local references for Cai Xukun, 蔡徐坤, caixukun, cxk, `gated-public-figure`, Cai Xukun source authority, `references/ips/caixukun`, `assets/<article-slug>-caixukun/`, `assets/&lt;article-slug&gt;-caixukun/`, `assets/<article-slug>-linux/`, and `assets/&lt;article-slug&gt;-linux/`. README and `examples/prompts.md` also keep Hermes Agent raw and escaped output markers: `assets/<article-slug>-hermes/` and `assets/&lt;article-slug&gt;-hermes/`.
...
This section is the Hermes Agent maintainer release gate for source review, MIT license context, uploaded-image authority, mythology-drift boundary, product-poster boundary, route leakage, public assets, generated samples, validator evidence, release channels, and final Hermes release review.

### Hermes Agent Source and MIT License Review

- [ ] Review `skills/visual-ip-illustrations/references/ips/hermes/source.md` for official website `https://hermes-agent.nousresearch.com/`, official repository `https://github.com/NousResearch/hermes-agent`, MIT license URL `https://github.com/NousResearch/hermes-agent/blob/main/LICENSE`, documentation URL `https://hermes-agent.nousresearch.com/docs/`, source authority, uploaded-image authority, route status, allowed use, restricted use, distribution boundary, sample policy, and review owner.
- [ ] Confirm route status remains `source-reviewed`, source authority remains `skills/visual-ip-illustrations/references/ips/hermes/source.md`, and route-local directory remains `skills/visual-ip-illustrations/references/ips/hermes/`.
- [ ] Confirm public docs keep raw output path `assets/<article-slug>-hermes/`, docs validation token `assets/&lt;article-slug&gt;-hermes/`, uploaded-image authority from `Generated image 1 (16).jpeg`, official source context, MIT license context, public sample review gate, route isolation, and uploaded-character-only article illustration output.
- [ ] Record source/MIT review: PENDING / reviewer / date / approval status / source record / release channels / official source outcome / MIT license outcome / uploaded-image identity outcome / mythology-drift outcome / product-poster boundary outcome / route-isolation outcome.

### Hermes Agent Uploaded-Image and Boundary Review

- [ ] Confirm Hermes Agent output remains uploaded-character-only article illustration output using the uploaded-image authority from `Generated image 1 (16).jpeg`.
- [ ] Confirm mythology-drift boundary excludes Greek messenger framing, winged sandals, winged helmet, caduceus imagery, and Olympian deity framing from default route output.
- [ ] Confirm product-poster boundary excludes product advertising, product-poster output, CLI screenshots, web hero graphics, broad assistant framing, official endorsement, affiliation, sponsorship, approval, and impersonation claims from generated examples and release copy.

### Hermes Agent Prompt Leakage Scan

- [ ] Scan Xiaohei, Littlebox, Tom, Ferris, Seal, OpenClaw, Go Gopher, and Cai Xukun route-local references for Hermes Agent, Hermes, hermes-agent, Hermes logo, Hermes Agent logo, `source-reviewed`, Hermes source authority, `references/ips/hermes`, `Generated image 1 (16).jpeg`, `assets/<article-slug>-hermes/`, and `assets/&lt;article-slug&gt;-hermes/`.
- [ ] Confirm Hermes Agent wording stays route-local so official source context, MIT license context, uploaded-image authority, mythology-drift boundary, product-poster boundary, and public sample gate stay isolated from other route contracts.
- [ ] Confirm generated public Hermes samples require release review for source/MIT attribution, uploaded-image identity, route isolation, mythology-drift, product-poster boundary, and article-metaphor quality before release channels list them.

### Hermes Agent Public Asset Policy

- [ ] Hermes Agent public asset policy for `examples/images/`, `examples/images-en/`, and `skills/visual-ip-illustrations/assets/examples/`: PENDING / reviewer / date / approval status / allowed directories / release channels / official source outcome / MIT license outcome / uploaded-image identity outcome / mythology-drift outcome / product-poster boundary outcome / route-isolation outcome / uploaded-character-only article illustration outcome / public-sample decision.
- [ ] Public generated Hermes sample assets remain pending and are not approved for publication in `examples/images/`, `examples/images-en/`, `skills/visual-ip-illustrations/assets/examples/`, README galleries, or release materials.
- [ ] Public generated Hermes sample approval must cover official source context, MIT license context, uploaded-image authority, mythology-drift boundary, product-poster boundary, route isolation, uploaded-character-only article illustration output, allowed directories, release channels, endorsement, affiliation, sponsorship, approval, impersonation review, and public-sample decision.

### Hermes Agent Generated Sample Policy

- [ ] Internal review samples under `assets/<article-slug>-hermes/` may be used when the source record, MIT license context, uploaded-image authority, mythology-drift boundary, and product-poster boundary stay attached.
- [ ] Public generated samples from `assets/<article-slug>-hermes/` require Hermes Agent Public Asset Policy approval before release channels list or copy them into public sample directories.
- [ ] Record generated sample review: PENDING / reviewer / date / approval status / internal review directories / public directories / release channels / official source outcome / MIT license outcome / uploaded-image identity outcome / mythology-drift outcome / product-poster boundary outcome / route-isolation outcome / endorsement, affiliation, sponsorship, approval, impersonation review outcome / article-metaphor quality outcome.

### Final Hermes Release Review

- [ ] Final Hermes release review confirms `skills/visual-ip-illustrations/references/ips/hermes/source.md` is the authority for official source context, MIT license context, uploaded-image authority, mythology-drift boundary, product-poster boundary, distribution boundary, sample policy, and review owner.
- [ ] Final Hermes release review confirms route status `source-reviewed`, NOTICE consistency, README/examples/metadata parity, routing parity, public asset approvals, generated sample approvals, and Phase 52 validator parity, Node tests, final release evidence, docs consistency, leakage scan, and public sample gate automation before public generated sample release.
- [ ] Final Hermes release review requires green evidence from `node scripts/validate-skill-package.mjs`, `node --test scripts/validate-skill-package.test.mjs`, and `git diff --check`.

## Linux Mascot Source, Trademark, Uploaded-Image Authority, and Public Sample Gate

This section is the Linux Mascot maintainer release gate for Tux source review, Linux trademark guidance, uploaded-image authority, distro-logo boundary, product-output boundary, route leakage, public assets, generated samples, validator evidence, release channels, and final Linux Mascot release review. Phase 57 owns validator, Node, leakage, smoke, sample-gate automation, and final evidence.

### Linux Mascot Source and Trademark Review

- [ ] Review `skills/visual-ip-illustrations/references/ips/linux/source.md` for Linux 2.0 Penguins source `https://isc.tamu.edu/~lewing/linux/`, Larry Ewing Tux attribution, The GIMP attribution condition, Linux Foundation trademark guidance `https://www.linuxfoundation.org/legal/trademark-usage`, Linux mark ownership context `https://www.linuxfoundation.org/legal/the-linux-mark`, source authority, uploaded-image authority, route status, allowed use, restricted use, distribution boundary, sample policy, and review owner.
- [ ] Confirm route status remains `source-reviewed`, source authority remains `skills/visual-ip-illustrations/references/ips/linux/source.md`, and route-local directory remains `skills/visual-ip-illustrations/references/ips/linux/`.
- [ ] Confirm public docs keep raw output path `assets/<article-slug>-linux/`, docs validation token `assets/&lt;article-slug&gt;-linux/`, uploaded-image authority from `/Users/longnv/Downloads/Linux-logo.jpg`, Larry Ewing Tux attribution, The GIMP attribution condition, Linux trademark boundary, public sample review gate, route isolation, distro-logo boundary, product-output boundary, and uploaded-image-only Tux article illustration output.
- [ ] Record source/trademark review: PENDING / reviewer / date / approval status / source record / release channels / Tux source outcome / GIMP attribution outcome / Linux trademark outcome / uploaded-image identity outcome / distro-logo boundary outcome / endorsement/certification boundary outcome / product-output outcome / route-isolation outcome.

### Linux Mascot Uploaded-Image and Boundary Review

- [ ] Confirm Linux Mascot output remains uploaded-image-only Tux article illustration output using uploaded-image authority from `/Users/longnv/Downloads/Linux-logo.jpg`.
- [ ] Confirm Tux markers preserve glossy black rounded penguin head and body, white face eye patches, large oval eyes with dark pupils and small highlights, yellow-orange beak with two nostril dots, white oval belly, long black flippers, seated rounded posture, and oversized yellow-orange webbed feet.
- [ ] Confirm distro-logo boundary excludes distro logos, distro mascots, distro badges, package-manager marks, Linux Foundation logo use, and distro branding from route identity.
- [ ] Confirm product-output boundary excludes official endorsement, certification, compatibility, Linux Foundation campaign framing, product advertising, product-poster output, CLI screenshots, web hero graphics, kernel dashboard screenshots, and operating-system marketing graphics from generated examples and release copy.

### Linux Mascot Prompt Leakage Scan

- [ ] Scan Xiaohei, Littlebox, Tom, Ferris, Seal, OpenClaw, Go Gopher, Cai Xukun, and Hermes Agent route-local references for Linux Mascot, Tux, `source-reviewed`, Linux source authority, `references/ips/linux`, `/Users/longnv/Downloads/Linux-logo.jpg`, `assets/<article-slug>-linux/`, and `assets/&lt;article-slug&gt;-linux/`.
- [ ] Confirm Linux Mascot wording stays route-local so Larry Ewing Tux attribution, The GIMP attribution condition, Linux trademark-boundary note, uploaded-image authority, distro-logo boundary, product-output boundary, and public sample gate stay isolated from other route contracts.
- [ ] Confirm generated public Linux Mascot samples require release review for Tux source outcome, GIMP attribution outcome, Linux trademark outcome, uploaded-image identity outcome, route isolation, distro-logo boundary, endorsement/certification boundary, product-output outcome, and article-metaphor quality before release channels list them.

### Linux Mascot Public Asset Policy

- [ ] Linux Mascot public asset policy for `examples/images/`, `examples/images-en/`, and `skills/visual-ip-illustrations/assets/examples/`: PENDING / reviewer / date / approval status / allowed directories / release channels / Tux source outcome / GIMP attribution outcome / Linux trademark outcome / uploaded-image identity outcome / distro-logo boundary outcome / endorsement/certification boundary outcome / product-output outcome / route-isolation outcome / uploaded-image-only Tux article illustration outcome / public-sample decision.
- [ ] Public generated Linux Mascot samples remain pending and are not approved for publication in `examples/images/`, `examples/images-en/`, `skills/visual-ip-illustrations/assets/examples/`, README galleries, or release materials.
- [ ] Public generated Linux Mascot sample approval must cover Larry Ewing Tux attribution, The GIMP attribution condition, Linux trademark guidance, uploaded-image authority, route isolation, distro-logo boundary, product-output boundary, allowed directories, release channels, endorsement, certification, compatibility, Linux Foundation logo use, product-poster output, CLI screenshots, web hero graphics, kernel dashboard screenshots, operating-system marketing graphics, and public-sample decision.

### Linux Mascot Generated Sample Policy

- [ ] Internal review samples under `assets/<article-slug>-linux/` may be used when the source record, uploaded-image authority, Tux source context, The GIMP attribution condition, Linux trademark boundary, distro-logo boundary, and product-output boundary stay attached.
- [ ] Public generated samples from `assets/<article-slug>-linux/` require Linux Mascot Public Asset Policy approval before release channels list or copy them into public sample directories.
...
- [ ] Final Linux Mascot release review confirms `skills/visual-ip-illustrations/references/ips/linux/source.md` is the authority for Tux source context, The GIMP attribution condition, Linux trademark guidance, uploaded-image authority, distro-logo boundary, product-output boundary, distribution boundary, sample policy, and review owner.
- [ ] Final Linux Mascot release review confirms route status `source-reviewed`, NOTICE consistency, README/examples/metadata parity, routing parity, public asset approvals, generated sample approvals, and Phase 57 validator parity, Node tests, final release evidence, docs consistency, leakage scan, route smoke, public sample gate automation, and generated sample gate automation before public generated sample release.
- [ ] Final Linux Mascot release review requires green evidence from `node scripts/validate-skill-package.mjs`, `node --test scripts/validate-skill-package.test.mjs`, and `git diff --check`.

## Installable Package Boundary

- [ ] Confirm the installable Codex Skill package is `skills/visual-ip-illustrations/`.
- [ ] Confirm `skills/visual-ip-illustrations/` contains `SKILL.md`, `agents/openai.yaml`, `references/routing.md`, Xiaohei, Littlebox, Tom, Ferris, Seal, OpenClaw, Go Gopher, Cai Xukun, Hermes Agent, and Linux Mascot canonical IP packs, legacy Xiaohei reference entry points, and skill-local assets.
...
- [ ] Confirm Phase 52 owns Hermes Agent validator parity, Node tests, final release evidence, docs consistency, leakage scan, and public sample gate automation.
- [ ] Confirm Phase 57 owns Linux Mascot validator parity, Node tests, final release evidence, docs consistency, leakage scan, route smoke, public sample gate automation, and generated sample gate automation.

## Public Docs and Path Markers

- [ ] README documents Xiaohei as the default visual IP, Littlebox as an explicit active route, Tom as an explicit `gated-authorized` protected-character route, Ferris as an explicit `source-reviewed` Rust-community mascot route, Seal as an explicit `active` product-neutral hoodie seal route, OpenClaw as an explicit `source-reviewed` logo-mascot route, Go Gopher as an explicit `source-reviewed` article-mascot route, and Cai Xukun as an explicit `gated-public-figure` stylized mascot-only route. Hermes Agent as an explicit `source-reviewed` uploaded-image article-illustration route, and Linux Mascot as an explicit `source-reviewed` uploaded-image Tux article-illustration route.
...
- [ ] README, `examples/prompts.md`, `skills/visual-ip-illustrations/agents/openai.yaml`, `NOTICE.md`, `RELEASE_CHECKLIST.md`, and `skills/visual-ip-illustrations/references/routing.md` keep public Hermes Agent source/MIT/uploaded-image wording aligned.
- [ ] README, `examples/prompts.md`, `skills/visual-ip-illustrations/agents/openai.yaml`, `NOTICE.md`, `RELEASE_CHECKLIST.md`, and `skills/visual-ip-illustrations/references/routing.md` keep public Linux Mascot source/trademark/uploaded-image wording aligned.
...
- [ ] README, prompt docs, and release docs keep canonical pack paths for `skills/visual-ip-illustrations/references/ips/xiaohei/`, `skills/visual-ip-illustrations/references/ips/littlebox/`, `skills/visual-ip-illustrations/references/ips/tom/`, `skills/visual-ip-illustrations/references/ips/ferris/`, `skills/visual-ip-illustrations/references/ips/seal/`, `skills/visual-ip-illustrations/references/ips/openclaw/`, `skills/visual-ip-illustrations/references/ips/gopher/`, and `skills/visual-ip-illustrations/references/ips/caixukun/`. Public docs and release docs also keep canonical pack paths `skills/visual-ip-illustrations/references/ips/hermes/` and `skills/visual-ip-illustrations/references/ips/linux/`.
...
- [ ] Hermes Agent public docs keep `skills/visual-ip-illustrations/references/ips/hermes/source.md`, `source-reviewed`, aliases `Hermes Agent`, `Hermes`, `hermes`, `hermes-agent`, `Hermes logo`, and `Hermes Agent logo`, official website `https://hermes-agent.nousresearch.com/`, official repository `https://github.com/NousResearch/hermes-agent`, MIT license URL `https://github.com/NousResearch/hermes-agent/blob/main/LICENSE`, docs URL `https://hermes-agent.nousresearch.com/docs/`, uploaded-image authority from `Generated image 1 (16).jpeg`, public sample review gate, mythology-drift boundary, product-poster boundary, route isolation, uploaded-character-only article illustration output, `assets/<article-slug>-hermes/`, `assets/&lt;article-slug&gt;-hermes/`, endorsement, affiliation, sponsorship, approval, and impersonation review wording, and the Phase 52 validator/test boundary visible before public generated sample release.
- [ ] Linux Mascot public docs keep `skills/visual-ip-illustrations/references/ips/linux/source.md`, `source-reviewed`, aliases `Linux Mascot`, `Linux mascot`, `Linux`, `linux`, `Tux`, `tux`, `Linux penguin`, and `Tux penguin`, Linux 2.0 Penguins source `https://isc.tamu.edu/~lewing/linux/`, Larry Ewing Tux attribution, The GIMP attribution condition, Linux Foundation trademark guidance `https://www.linuxfoundation.org/legal/trademark-usage`, Linux mark ownership context `https://www.linuxfoundation.org/legal/the-linux-mark`, Linux is the registered trademark of Linus Torvalds in the U.S. and other countries, uploaded-image authority from `/Users/longnv/Downloads/Linux-logo.jpg`, public sample review gate, distro-logo boundary, product-output boundary, route isolation, uploaded-image-only Tux article illustration output, `assets/<article-slug>-linux/`, `assets/&lt;article-slug&gt;-linux/`, endorsement/certification/compatibility review wording, and the Phase 57 validator/test boundary visible before public generated sample release.
